...
{
	public static String privateKey ="cert\\testSpay.key.p8";	//商户私钥
	//public static String privateKey ="cert\\52579_.key.p8";	//商户私钥

	public static String certFilePath = "cert\\";	//联动证书
	public static String serverCertFileName = "testUmpay.cert.crt";
	
    public static void main( String[] args ) 
    {
//        System.out.println(addSign());
//        System.out.println(doCheckSign(addSign()));
...
//    	reqMap =new TreeMap<String, Object>();
