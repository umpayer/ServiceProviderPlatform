...
public class PublicNumberAndMinorProcedures {
	//public String payUrl ="http://106.120.215.230:8011/entry-provider-plat-client/pay/unifiedOrder";
	public String payUrl ="http://10.10.55.66:6904/pay/unifiedOrder";

	@Test
	public void beSweptAPi() throws UnsupportedEncodingException, GeneralSecurityException, IOException{
